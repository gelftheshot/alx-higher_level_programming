...
class TestSquare_area(unittest.TestCase):
    """TESt for area method of square class."""

    def test_area_small(self):
        self.assertEqual(64, Square(8, 1, 0, 1).area())

    def test_area_random(self):
        s = Square(12341234, 0, 0, 1)
        self.assertEqual(12341234**2, s.area())
